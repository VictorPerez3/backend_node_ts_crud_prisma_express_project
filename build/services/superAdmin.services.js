...
const isSuperAdmin = (reqHeaderAuth) => __awaiter(void 0, void 0, void 0, function* () {
    //Retorna o usuario pelo Token
    const userToken = yield authServices.decodedTokenSuperAdmin(reqHeaderAuth);
    if (!userToken || !userToken.email) {
        return false;
    }
    else {
        //Verifica se o usuario é Super Admin
        if ((yield superAdminRepository.returnSuperAdmin(userToken.email)) === null) {
            return false;
        }
        else {
            return true;
...
//# sourceMappingURL=superAdmin.services.js.map